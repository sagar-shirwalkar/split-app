...
(function setup() {
  ...
  var fieldDefs = {
    ...
    x_split_membership: [
      { n: "group", t: "glide_object", man: true, ref: "x_split_group" },
  ...
  var choiceDefs = [
    ...
    { t: "x_split_expense", e: "split_type", v: ["equal", "exact", "percentage", "shares"] },
  ...
  function getOpScript(name) {
    ...
    attGr.addQuery("table_name", "x_split_setup");
  ...
  var opDefs = [
    ...
    },
    {
      ...
      script: '(function process(request, response) { var groupId = request.pathParams.groupId; var body = request.body.data; body.group = groupId; var mgr = new x_split.ExpenseManager(); var expId = mgr.createExpense(body); response.setStatus(201); return { sys_id: expId }; })(request, response)',
    },
    {
      name: "get_expenses",
      method: "GET",
    ...
    },
    {
      ...
      script: '(function process(request, response) { var groupId = request.pathParams.groupId; var expenseId = request.pathParams.expenseId; var body = request.body.data; var mgr = new x_split.ExpenseManager(); mgr.updateExpense(expenseId, body); return { sys_id: expenseId }; })(request, response)',
    },
    {
      name: "delete_expense",
      method: "DELETE",
      path: "groups/{groupId}/expenses/{expenseId}",
      script: '(function process(request, response) { var groupId = request.pathParams.groupId; var expenseId = request.pathParams.expenseId; var utils = new x_split.SplitUtils(); utils.requireMembership(groupId); var mgr = new x_split.ExpenseManager(); mgr.deleteExpense(expenseId); return { status: "deleted" }; })(request, response)',
    },
    {
      name: "get_expense",
      method: "GET",
    ...
    },
    {
      ...
      script: '(function process(request, response) { var groupId = request.pathParams.groupId; var utils = new x_split.SplitUtils(); utils.requireMembership(groupId); var calc = new x_split.BalanceCalculator(); var balances = calc.getGroupBalances(groupId); return balances; })(request, response)',
    },
    {
  ...
  for (var oi = 0; oi < opDefs.length; oi++) {
    ...
    oex.query();
    var resourcePath = "/api/x_split/" + od.path;
    if (oex.next()) {
