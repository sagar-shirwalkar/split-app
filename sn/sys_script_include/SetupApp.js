...
SetupApp.prototype = {
  ...
  createTables: function () {
    var names = ["x_snc_split_group", "x_snc_split_membership", "x_snc_split_expense", "x_snc_split_share", "x_snc_split_settlement"];
  ...
  createFields: function () {
    var results = {};
    results.x_snc_split_group = this._groupFields();
    results.x_snc_split_membership = this._membershipFields();
    results.x_snc_split_expense = this._expenseFields();
    results.x_snc_split_share = this._shareFields();
    results.x_snc_split_settlement = this._settlementFields();
    return results;
  },
  ...
  _membershipFields: function () {
    var t = "x_snc_split_membership";
    return [
      this._field(t, "group", "glide_object", { mandatory: true, reference: "x_snc_split_group" }),
  ...
  _shareFields: function () {
    var t = "x_snc_split_share";
    return [
      this._field(t, "expense", "glide_object", { mandatory: true, reference: "x_snc_split_expense" }),
      this._field(t, "user", "glide_object", { mandatory: true, reference: "sys_user" }),
      this._field(t, "amount", "decimal", { mandatory: true }),
  ...
  createChoices: function () {
    var defs = [
      { table: "x_snc_split_group", element: "base_currency", values: ["USD", "EUR", "INR", "GBP"] },
      { table: "x_snc_split_expense", element: "category", values: ["Food & Drink", "Travel", "Utilities", "Entertainment", "Other"] },
      { table: "x_snc_split_expense", element: "split_type", values: ["equal", "exact", "percentage", "shares"] },
      { table: "x_snc_split_membership", element: "role", values: ["admin", "member"] },
    ];
    var results = {};
